...
def test_transient_psi_error():
    from pagespeed_api_checker import is_transient_psi_error
    assert is_transient_psi_error("FAILED_DOCUMENT_REQUEST … net::ERR_TIMED_OUT")
    assert not is_transient_psi_error("PSI HTTP 403: forbidden")
